...
class TransformIterator(IteratorBase):
    ...
    Similar to `thrust::transform_iterator <https://nvidia.github.io/cccl/3.4/thrust/api/classthrust_1_1transform__iterator.html>`_.
...
class TransformOutputIterator(TransformIterator):
    ...
    Similar to `thrust::transform_output_iterator <https://nvidia.github.io/cccl/3.4/thrust/api/classthrust_1_1transform__output__iterator.html>`_.
